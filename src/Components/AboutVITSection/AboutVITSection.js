        ...
        <article className="aboutSection">
          <section>
            ...
            <p className="aboutContent">
              Vellore Institute of Technology, Vellore is one of the most
              revered and distinguished engineering institutions. It holds the
              rare distinction of being one among the few colleges to impart
            ...
            <p className="aboutContent">
              Vellore Institute of Technology was the birth-child of the
              tireless and relentless perseverance of our respected Chancellor,
              Dr. G. Viswanathan. The ultimate objective of this institution has
              been to provide an environment that would help foster intellectual
              aptitude, enhance human perception and create a society of
              extraordinary professionals. It moulds individuals capable of
              thinking new, out-of-the-box ideas and having the skills to
              implement them, to help the entire society as a whole.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="aboutContent">
              Code2Create is ACM-VIT's flagship event, and it is among the
              biggest hackathons hosted in VIT.
              ...
              participants from across the country. The 36-hour long hackathon
              is filled with intense brainstorming, creating and testing.
              Industry experts serve as guest judges for the same and host
              engaging spaces for the participants.
            </p>
          </section>
        </article>
